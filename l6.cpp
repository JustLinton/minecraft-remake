...
int main()
{
    ...
    Shader lightingShader("shaders/blinn-phong-material.vs", "shaders/blinn-phong-material.frag");
	...
	// gold
      ...
      //   glUniform3f(glGetUniformLocation(lightingShader.Program, "material.diffuse"),   0.75164f, 0.60648f, 0.22648f);
      //   glUniform3f(glGetUniformLocation(lightingShader.Program, "material.specular"),  0.628281f, 0.555802f, 0.366065f); 
      //   glUniform1f(glGetUniformLocation(lightingShader.Program, "material.shininess"), 51.2f);
